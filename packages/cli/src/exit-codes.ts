...
const BY_CLI_CODE: Readonly<Record<CliErrorCode, ExitCode>> = {
  ...
  // Nothing was signed: a definitive refusal, and a retry gets the same bytes.
  TRANSACTION_REFUSED: EXIT_CODES.REJECTED,
  DEPLOYMENT_UNAVAILABLE: EXIT_CODES.UNAVAILABLE,
